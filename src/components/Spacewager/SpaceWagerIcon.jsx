...
export default function SpaceWagerIcon(props) {
    ...
    return (
        ...
        <svg version="1.1" width="512" height="512" x="0" y="0" viewBox="0 0 512 512" style={{enableBackground:'new 0 0 512 512'}} xmlSpace="preserve" className=""><g xmlns="http://www.w3.org/2000/svg">
        <path d="m256 271.936 42.247 76.354-42.247 70.949h-40.684c-6.464 0-12.197-4.13-14.239-10.259l-23.794-71.346z" fill="#9580ff" data-original="#9580ff" class=""/>
        ...
        <path d="m341.467 219.802-20.984 69.851 76.431 93.258 95.387-12.039c-.51-3.09-1.991-6.02-4.362-8.31z" fill="#9580ff" data-original="#9580ff" class=""/>
        <path d="m115.086 382.911v114.064c0 15.119-19.852 20.739-27.786 7.87l-66.05-124.494c-1.581-2.99-2.071-6.32-1.551-9.479l66.553-31.036z" fill="#9580ff" data-original="#9580ff" class=""/>
