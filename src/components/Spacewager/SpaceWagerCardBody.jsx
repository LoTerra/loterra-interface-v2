...
export default function SpaceWagerCardBody(props) {
    ...
    function format_number(number, sizeOne, sizeTwo) {
        ...
        let format_variation =
            split_variation.length == 1 ? (
                <>
                    {split_variation[0]}
                    <span style={{ fontSize: sizeOne }}>.000000</span>
                </>
            ) : (
                <>
                    {split_variation[0]}
                    <span style={{ fontSize: sizeTwo }}>
                        .{split_variation[1]}
                    </span>
                </>
            )
    ...
    function format_last_price(number) {
        ...
        return {
            lastPricePart1: split_variation[0],
            lastPricePart2:
                split_variation.length == 1 ? '000000' : split_variation[1],
        }
    }
    function last_price() {
        if (isLivePrediction || (isPastPrediction && obj.success == null)) {
            ...
            if (isPastPrediction) {
                ...
                let { lastPricePart1, lastPricePart2 } =
                    format_last_price(price)
                    ...
                    <>
                        <div className="row">
                            <div className="col-12 text-start">
                                <p className="my-1 mb-0 small text-muted">
                                    Last price
                                </p>
                            </div>
                            <div className="col-6 text-start">
                                ...
                                >
                                    ...
                                    {isPastPrediction ? (
                                        ...
                                        <>
                                            <CountUp
                                                start={prevLastPricePart1}
                                                end={lastPricePart1}
                                            />
                                            <CountUp
                                                prefix="."
                                                style={{ fontSize: '0.5em' }}
                                                start={prevLastPricePart2}
                                                end={lastPricePart2}
                                            />{' '}
                                        </>
                                    )}
                        ...
                        <div className="row">
                            <div className="col-6 text-start">
                                <p className="mb-2 fw-bold fs-6 mb-0">
                                    Prize Pool:
                                </p>
                            </div>
                            <div className="col-6 text-end">
                        ...
                        {bidScreen ? (
                            <div>
                                <div className="row">
                                    <div className="col-12">
                                        <button
                                            className={
                                                'btn btn-secondary float-start p-1 px-2'
                                            }
                                            onClick={() => makeBid()}
                                        >
                                            <ArrowLeft size={'18'} />
                                    ...
                                    <div className="col-6 text-start">
                                        <p className="fw-regular fs-6 mb-0 mt-2">
                                            Commit:
                                        </p>
                                    </div>
                                </div>
                                ...
                                {state.wallet &&
                                    state.wallet.hasOwnProperty(
                                        'walletAddress',
                                    ) && (
                                        <button
                                            onClick={() =>
                                                makeBidFinal(obj.prediction_id)
                                            }
                                            className={
                                                'btn w-100 mt-1' +
                                                (bidType == 'UP'
                            ...
                            <div className="row">
                                ...
                                <div className="col-12 my-3">
                                    <button
                                        className="btn btn-up btn-lg mb-2"
                                        onClick={() => makeBid('UP')}
                                    >
                                        Enter UP
                                    </button>
                                    <button
                                        className="btn btn-down btn-lg"
