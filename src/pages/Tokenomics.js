...
export default () => {
    ...
    function marketCap() {
        if (lotaPriceOnTerraswap.assets) {
            let sum =
                (lotaPriceOnTerraswap.assets[1].amount /
                    lotaPriceOnTerraswap.assets[0].amount) *
                circulatingSupply()
            return sum
        }
    }
    ...
    function loopUstPrice() {
        if (loopPrice.assets && loopPrice.assets) {
            let lotaLoop =
                lotaLoopPriceOnLoop.assets[0].amount /
                lotaLoopPriceOnLoop.assets[1].amount
            let loopUst =
                loopPrice.assets[1].amount / loopPrice.assets[0].amount
        ...
        <>
            ...
            <div className="w-100 py-3 py-md-5 text-center">
                ...
                <h2 className="my-2 fw-regular fs-6 mb-0 px-3 px-md-5 text-muted">
                    ...
                    job is to ensure the ecosystem is working well, they can
                    control lotteries configurations and get staking rewards for
                            ...
                            <div className="lota-stats">
                                {lotaPriceOnTerraswap.assets && (
                                    <>
                                        ...
                                        <h5>
                                            {numeral(
                                                lotaPriceOnTerraswap.assets[1]
                                                    .amount /
                                                    lotaPriceOnTerraswap
                                                        .assets[0].amount,
                                            ).format('0.000')}
                                            <span>UST</span>
                                        </h5>
                            ...
                            <tbody>
                                    ...
                                    <td className="text-center">
                                        <>
                                            <button
                                                ...
                                                onClick={() =>
                                                    window.open(
                                                        'https://app.terraswap.io/swap?to=&type=swap&from=uluna',
                                                        '_blank',
                                                    )
                                                }
                                            >
                                                <img
                                                    src="/Terraswap-Icon.png"
                                                    style={{ maxWidth: '30px' }}
                                ...
                                <tr>
                                    ...
                                    <td className="text-center">
                                        <>
                                            <button
                                                ...
                                                onClick={() =>
                                                    window.open(
                                                        'hhttps://dex.loop.markets/swap#Swap',
                                                        '_blank',
                                                    )
                                                }
                                            >
                                                <img
                                                    src="/LoopFinance-logo.png"
                                                    style={{ maxWidth: '30px' }}
                                                    className="img-fluid align-self-center"
                                                />
                                                Loop Finance
                                    ...
                                    <td className="text-center">
                                        ...
                                        $
                                        {lotaPriceOnLoop &&
                                        lotaPriceOnLoop.assets
                                            ? numeral(
                                                  lotaPriceOnLoop.assets[1]
                                                      .amount /
                                                      lotaPriceOnLoop.assets[0]
                                                          .amount,
                                              ).format('0.000')
                                            : ''}
                                    </td>
                                    ...
                                    <td className="text-center">
                                        <>
                                            <button
                                                ...
                                                onClick={() =>
                                                    window.open(
                                                        'https://app.astroport.fi/swap?from=terra1ez46kxtulsdv07538fh5ra5xj8l68mu8eg24vr&to=uusd',
                                                        '_blank',
                                                    )
                                                }
                                            >
                                ...
                                <tr>
                                    ...
                                    <td className="text-center">
                                        {' '}
                                        $
                                        {lotaPriceOnAstroport &&
                                        lotaPriceOnAstroport.assets
                                            ? numeral(
                                                  lotaPriceOnAstroport.assets[1]
                                                      .amount /
                                                      lotaPriceOnAstroport
                                                          .assets[0].amount,
                                              ).format('0.000')
